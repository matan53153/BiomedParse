#!/bin/bash
#SBATCH --job-name=biomedparse-train-vit # Job name
...
#SBATCH --output=slurm_train_vit_%j.log  # Standard output and error log (%j expands to jobId)
